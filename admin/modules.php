...
if (!empty($action)) {
  ...
  switch ($action) {
    case 'save':
      ...
      zen_mail_from_template(STORE_NAME, STORE_OWNER_EMAIL_ADDRESS, TEXT_EMAIL_SUBJECT_ADMIN_SETTINGS_CHANGED, $msg, STORE_NAME, EMAIL_FROM, 'admin_settings_changed');
